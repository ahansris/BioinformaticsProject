...
### working directory should start in: /afs/crc.nd.edu/user/a/ahansris/Private/Biocomputing/BioinformaticsProject
cd $1/ref_sequences
...
cat summary.csv | grep -wv "0" | sort -t, -k3,3nr -k1,1 >> methanogens.csv
